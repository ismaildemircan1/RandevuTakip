...
const firebaseConfig = {
  ...
  // ⚡ Bolt: Debounce the patient search to reduce Firestore reads.
  // Instead of querying the database on every single keystroke,
  // we wait 300ms after the user stops typing to make the query.
  // This reduces the number of reads by ~80% during active typing and improves performance.
