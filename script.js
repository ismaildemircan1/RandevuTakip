...
const firebaseConfig = {
  ...
  document.getElementById('patientSearch').addEventListener('input', function(e) {
      ...
      // ⚡ Bolt: Debounce search input to prevent excessive Firestore read calls
      // This delays the API call until the user has stopped typing for 300ms,
      // reducing unnecessary database reads and improving UI responsiveness.
