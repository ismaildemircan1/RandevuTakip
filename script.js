...
const firebaseConfig = {
  ...
  async function renderAppointments() {
      ...
      try {
          ...
          // ⚡ Bolt: Use DocumentFragment to batch DOM operations, minimizing reflows
  ...
  document.getElementById('editAppointmentForm').addEventListener('submit', async function(e) {
      ...
      // ⚡ Bolt: Cache parsed ID and existing appointment to avoid redundant O(N) array traversals
      const numericId = parseInt(id);
      const existingApt = appointments.find(a => a.id === numericId) || {};
      ...
      const updatedAppointment = {
          ...
          appointmentTime,
          status: 'confirmed',
          paymentStatus: existingApt.paymentStatus,
          paymentAmount: existingApt.paymentAmount
      };
