...
const firebaseConfig = {
  ...
  document.getElementById('patientSearch').addEventListener('input', function(e) {
      ...
      // ⚡ Bolt: Filter patients locally instead of making a Firestore query on every keystroke
      // Reduces network latency, eliminates unnecessary DB reads, and prevents global state mutation.
