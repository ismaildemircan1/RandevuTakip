...
const firebaseConfig = {
  ...
  async function renderAppointments() {
      ...
      try {
          ...
          // Bolt: Used DocumentFragment to batch DOM appends and minimize browser reflows
  ...
  document.getElementById('editAppointmentForm').addEventListener('submit', async function(e) {
      ...
      // Bolt: Caching parsed ID and array .find() to avoid redundant parsing and array traversals
      const parsedId = parseInt(id);
      const existingApt = appointments.find(a => a.id === parsedId);
      ...
      const updatedAppointment = {
          ...
          appointmentTime,
          status: 'confirmed',
          paymentStatus: existingApt ? existingApt.paymentStatus : 'pending',
          paymentAmount: existingApt ? existingApt.paymentAmount : 0
      };
