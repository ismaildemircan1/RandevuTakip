...
const firebaseConfig = {
  ...
  async function renderAppointments() {
      ...
      try {
          ...
          // ⚡ Bolt: Batch DOM updates using DocumentFragment to prevent layout thrashing and reduce reflows
  ...
  async function checkReminders() {
      try {
          ...
          const now = new Date();
          // ⚡ Bolt: Hoist constant calculation outside the loop to avoid redundant assignments
